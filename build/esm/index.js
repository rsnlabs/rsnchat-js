...
class RsnChat {
    ...
    getModels() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            try {
                const response = yield axios.get(`${apiUrl}models`, { headers: this.headers });
    ...
    chat(prompt, model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios.post(`${apiUrl}chat/generate`, { prompt, model }, { headers: this.headers });
    ...
    image(prompt, model) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios.post(`${apiUrl}image/generate`, { prompt, model }, { headers: this.headers });
                return response.data;
            }
            catch (error) {
    ...
    checkNSFW(image_url) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield axios.post(`${apiUrl}image/check-nsfw`, { image_url }, { headers: this.headers });
                return response.data;
            }
            catch (error) {
